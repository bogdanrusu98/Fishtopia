...
<span className="text-gray-700 dark:text-gray-200 text-5xl font-semibold">
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div className="max-w-md bg-white p-6 rounded-lg relative">
      ...
      >
        ✕
            ...
            <form onSubmit={onSubmit}>
              ...
              <label htmlFor="newPassword" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm New Password</label>
              <input
                type="password"
                id="newPassword"
                value={newPassword}
              ...
              <label htmlFor="avatar" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Upload Avatar</label>
              <input
                type="file"
                id="avatar"
                onChange={onChange}
              ...
              <button type="submit" className="w-full bg-blue-500 text-white py-2 px-4 rounded-md" disabled={loading}>
