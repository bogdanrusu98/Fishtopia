...
function Listing() {
  ...
  return (
    <main >
                <button
            onClick={() => navigate(-1)}
            className="mt-4 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-2 px-4 rounded flex items-center w-full md:w-auto"
          >
            ← Back
          </button>
      <div className="w-full md:container mx-auto p-4 bg-gray-50">
      {listing ? (
        <>
          ...
          <div className="flex items-center mb-4">
            ...
            <div className="text-gray-700">
              ...
              <p className="text-sm text-gray-500">Posted by {userName || 'Anonim'}</p>
            </div>
          </div>
          ...
          <div className="bg-gray-100 p-4 rounded-md">
            <ul className="max-w-md space-y-1 text-base md:text-lg text-zinc-500">
          ...
          {listing.description ? (
            <div className="bg-white p-4 mt-4 rounded-md">
              <p className="text-gray-700" dangerouslySetInnerHTML={{ __html: listing.description}} /> 
            </div>
          ) : (
            <div className="bg-white p-4 mt-4 rounded-md flex items-center space-x-2 text-red-600">
              <RiErrorWarningFill />
